export const survey = {
    list: [
        ...
        {
            title: `               
                <p><b>Situps</b> - consecutive number of sit-ups until exhaustion - feet held, hands clasping opposite shoulders, coming up so elbows touch the knees, upper back (not head) 'hitting' the ground.</p> 
        ...
        {
            title: `               
            <p><b>Pressups</b> - consecutive number of press ups until exhaustion - men on toes, women on knees.</p>
        ...
        {
            title: `               
                <p><b>Squats</b> - consecutive number of squats until exhaustion. Bottom must go down to mid-way between knees and ankles. Most people will need to use a heel raise to successfully complete the test.</p>    
        ...
        {
            title: `        
                <p><b>Arm hang (Second)</b> - hanging from a bar until exhaustion.</p> 
        ...
        {
            title: `        
                <p><b>Percent body fat (%)</b> - the gold standard for body composition is percent body fat. Theoretically, there is no need to measure how fat people are because generally speaking the fitter they are the closer they will be to their ideal weight. But having said that, its a useful metric to include in a fitness assessment.</p>                              
                <br><br>
            `,
            labels: [
                { name: "Men <br> Women", steps: [null, null]}, 
        ...
        {
            title: `        
                <strong>SUPPLEMENTARY TESTS</strong>
            
                <p><b>Flexibility</b> - the third major fact of fitness is flexibility. Tight muscles move bones out of alignment. Thats the bad news. The good news is that once you have a flexibility training program muscles can move bones back into alignment again; poor function is resorted to good. The body becomes pain free</p> 
                ...
                <br><br>
                <p><b>Flexibility</b> - sit and reach - test of hamstring flexibility</p> 
        ...
        {
            title: `        
            <p><b>Ability to sit up straight</b> - test of buttock flexibility</p>     
